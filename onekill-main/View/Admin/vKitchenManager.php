...
$list_user = $p->getAllKitchenStaff();
                ...
                if (!empty($list_user)) {
                  foreach ($list_user as $item) { ?>
                    <tr>
                      ...
                      <td><button class="btn btn-secondary"><a style="color: #fff;" href="admin.php?mod=DeleteUserTemporary&po=Kitchen&idTaiKhoan=<?php echo $item['idTaiKhoan'] ?>" onclick="return confirm('Bạn chắc chắn muốn xóa chứ!')">Xóa</a></button>
                        <button class="btn btn-secondary"><a href="admin.php?mod=UpdateUser&po=Kitchen&idTaiKhoan=<?php echo $item['idTaiKhoan'] ?>" style="color: #fff;">Sửa</a></button>
                      </td>
                    </tr>
                  <?php }
                } else {
