                                ...
                                if (!empty($delete)) {
                                    foreach ($delete as $item) { ?>
                                        <tr>
                                            ...
                                            <td><button class="btn btn-secondary"><a href="admin.php?mod=RestoreIngredient&idNguyenLieu=<?php echo $item['idNguyenLieu'] ?>" class="text-light">Khôi phục</a></button></td>
